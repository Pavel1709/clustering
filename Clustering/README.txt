...
В выходном файле clusterID.txt второй столбец соответствует координате х центра кластера, третий- координате у, а первый- идентификатору кластера. В выходном файле objectID.txt первый столбец соответствует идентификатору точки, второй - идентификатору кластера.
